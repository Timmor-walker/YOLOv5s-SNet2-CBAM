...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default='data/na.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default='runs/train/yolov5s/weights/last.pt', help='model.pt path(s)')
