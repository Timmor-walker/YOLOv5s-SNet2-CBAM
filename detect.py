...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='runs/train/yolov5s-shufflenetv2-headCBAM123/weights/last.pt', help='model.pt path(s)')
    parser.add_argument('--source', type=str, default='Na_dataSet/JPEGImages/029.jpg', help='file/dir/URL/glob, 0 for webcam')
